(function(){
    var init = function() {
        ...
        for (var i = 10; i < $('.rain').width() - 70; i += 35) {
            ...
            var duration = getRandomInt(800, 1200);
            $("<div class=\"raindrop\"><span></span></div>").css('left', i).css('animation-delay', delay + "ms").css('animation-duration', duration + 'ms').appendTo('.rain');
